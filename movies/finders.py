...
""" 
    Base "abstract" class, defines behaviour
"""
class MovieFinder:
...
"""
    Class to read movie data from a csv file
"""
class CsvMovieFinder(MovieFinder):
    ...
    def find_all(self) -> List[Movie]:
        """
            return a list of Movie instances created by the factory
            factory instance avoids dependency on the movie class constructor
        """
